...
namespace TornBot.Services.Database.PlayerStatus.Dao;

public class PlayerStatusDao : BaseDao<PlayerStatusDbContext>, IPlayerStatusDao
{
    private readonly DbSet<Entities.PlayerStatus> _dbSet;
    private IDbContextTransaction _transaction;
    
    public PlayerStatusDao(PlayerStatusDbContext context) : base(context)
    {
    ...
    public Entities.PlayerStatus? GetPlayerStatusData(UInt32 playerId, DateTime weekStarting)
    {
        // Have to use AsNoTracking because EF is not tracking the insert/update from above
